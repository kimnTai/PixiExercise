import { Container2d, Sprite2d, TRANSFORM_STEP } from "pixi-projection";
...
app.stage.addChild(container, squareX, squareY);

// add sprite itself

const bunny = new Sprite2d(PIXI.Texture.from("../img/bunny.png"));
...
const lightY = new Sprite2d(PIXI.Texture.WHITE);
...
const lightX = new Sprite2d(PIXI.Texture.WHITE);
squareY.tint = 0xff0000;
